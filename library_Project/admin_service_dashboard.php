...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><img class="imglogo" src="images/Log.png" width="450px" height="90px"/></div><br>
...
?>
            ...
            <p style="color:black"><u>Book Rent:</u> &nbsp&nbsp<?php $positivebookrent = ($bookrent < 0) ? -$bookrent : $bookrent; echo "$positivebookrent";
 ?></p>
            ...
            foreach($recordset as $row){
               ...
               "<td>$row[0]</td>";
                ...
                $table.="<td>$row[9]</td>";
                $bookrent = $row[10];
                $positivebookrent = ($bookrent < 0) ? -$bookrent : $bookrent;
                $table.="<td>$positivebookrent  </td>";
